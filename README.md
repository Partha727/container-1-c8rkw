...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1-c8rkw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1-c8rkw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Partha727/container-1-c8rkw.git
cd container-1-c8rkw
```
...
```
docker attach container-1-c8rkw
```
